import { HHC_PRESENTER_DEFAULT_ONEDRIVE_CLIENT_ID } from '@renderer/stores/settings'
import {
...
export async function createOneDriveAuthRequest(
  ...
  const clientId = input.clientId?.trim() || HHC_PRESENTER_DEFAULT_ONEDRIVE_CLIENT_ID
