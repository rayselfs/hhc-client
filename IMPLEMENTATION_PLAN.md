...
| Phase 4A: Presentation Readiness and Rehearsal              | Partial   | `ac0cc66 feat: add presentation readiness checks` adds readiness analysis foundation, and `f48faf8 feat: gate media presentation by readiness` adds a readiness-gated start helper that excludes unavailable items and preserves snapshot identities. Rehearsal mode, full readiness UI, and wiring every presentation entry point to the gate remain open.                                                                 |
...
3. Complete Phase 4A readiness UI, rehearsal mode, and wiring every presentation entry point to the
   readiness gate.
