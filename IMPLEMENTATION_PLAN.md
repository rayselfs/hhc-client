...
3. Complete Phase 4A readiness UI, rehearsal mode, and wiring every presentation entry point to the
   readiness gate.
4. Complete Phase 4B sync-cache eviction, dashboard actions, and redacted diagnostics export.
