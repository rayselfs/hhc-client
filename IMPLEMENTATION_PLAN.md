...
| Phase 4B: Storage Management Dashboard                      | Partial   | `6539c4a`, `055a643`, `fd8bb81`, and `4f93b90` add accounting, usage UI, cleanup, and integrity scanning foundations. Cache budgets, LRU eviction, full dashboard actions, and diagnostics export remain open.                                                                                                                                                                                 |
...
3. Complete Phase 4A readiness UI, rehearsal mode, and wiring every presentation entry point to the
   readiness gate.
4. Complete Phase 4B cache budgets, LRU eviction, dashboard actions, and redacted diagnostics export.
